...
name: humanizer
description: >-
  Remove signs of AI-generated writing and make text sound natural. Based on
  Wikipedia Signs of AI writing (33 patterns). Use for /humanizer, humanize,
  làm tự nhiên hơn, bớt văn AI. English-primary; partial Vietnamese support
  via vietnamese.md. Often chained after write-lncs-paper before saving files.
---

# Humanizer: Remove AI Writing Patterns

Upstream: [blader/humanizer](https://github.com/blader/humanizer) v2.8.0 (MIT). Installed for Cursor from `~/.claude/skills/humanizer`.

## Language support

| Language | Support |
|----------|---------|
| **English** | Full (33 patterns, primary) |
| **Vietnamese** | **Partial only.** No native VI pattern list in upstream. See [vietnamese.md](vietnamese.md) for cross-language rules and Vietnamese AI tells to apply manually. |

When humanizing **Vietnamese** academic prose: keep LNCS/`write-lncs-paper` constraints (no em dash, formal register, preserve metrics). Do not inject casual blog voice into paper sections.

## Chained use (write-lncs-paper)

When invoked automatically from `write-lncs-paper` Step 8:
